...
class App(tk.Frame):
    ...
    def settings(self):
        ...
        self.root1.wm_iconbitmap("assets/sprites/settings.ico")
    ...
    def about(self):
        ...
        self.root2.wm_iconbitmap("assets/sprites/info.ico")
    ...
    def records(self):
        ...
        self.root3.wm_iconbitmap("assets/sprites/records.ico")
...
def init_menu():
    ...
    root.wm_iconbitmap("assets/sprites/icon.ico")
